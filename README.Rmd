...
library(grid)
library(RCurl)
img <- readJPEG(getURLContent("https://raw.githubusercontent.com/joelcarlson/RImagePalette/master/figs/Desert.jpg"))
grid.raster(img)
``` 
